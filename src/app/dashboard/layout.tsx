...
type SidebarItem = SidebarLink | MenuGroup;
...
function DashboardLayoutInner({
  ...
  const [
    gestionAcademicaOpen,
    setGestionAcademicaOpen,
  ] = useState(true);
  ...
  const menuItems = useMemo<SidebarItem[]>(
    () => [
        ...
        items: [
          {
            title: t("navTeachers"),
            href:
              "/dashboard/catalogos?tab=docentes",
            icon: Users,
          },

          {
            title: t("navCourses"),
            href:
              "/dashboard/catalogos?tab=cursos",
            icon: BookOpen,
          },

          {
            title: t("navRooms"),
            href:
              "/dashboard/catalogos?tab=ambientes",
            icon: MapPin,
          },

          {
            title: t("navCycles"),
            href:
              "/dashboard/catalogos?tab=ciclos",
            icon: Layers,
          },

          {
            title: t("navPeriods"),
            href:
              "/dashboard/catalogos?tab=periodos",
            icon: Calendar,
          },
...

      {
        title: t("navWindows"),
        href:
          "/dashboard/catalogos?tab=ventanas",
        icon: ClipboardList,
        roles: [
          "administrador_sistema",
          "director_escuela",
  ...
  const userRol =
    session?.user?.rol as UserRole | undefined;
  ...
  const filteredBySearch = filteredMenu
    .map((item) => {
      if (isMenuGroup(item)) {
        ...
        return {
          ...item,
          items: matchesSearch(item.title)
            ? item.items
            : items,
        };
      }
  ...
  const displayMenu = searchQuery.trim()
    ? filteredBySearch
    : filteredMenu;
