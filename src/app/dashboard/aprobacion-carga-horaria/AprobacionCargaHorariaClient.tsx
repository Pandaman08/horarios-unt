        ...
        <CardContent className="p-0">
          ...
          <div className="p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-border bg-card">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-lg font-bold text-foreground leading-none">Aprobación de Carga Horaria</h1>
                <p className="text-muted-foreground text-xs mt-1">Gestión administrativa de declaraciones enviadas por los docentes</p>
              </div>
            </div>
