import { PrismaClient, CargoAcademicoAdministrativo } from '@prisma/client';

export async function seedCargosAcademicosAdministrativos(prisma: PrismaClient) {
  console.log('🌱 Seeding CargoAcademicoAdministrativo...');
  ...
  console.log('✅ CargoAcademicoAdministrativo seeded successfully!');
}
